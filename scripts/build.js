...
const sharedScript = `
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Scrollbar nA — thumb vertical en canvas 32×800
            ...
            if (naThumb) {
                ...
                function updateNaThumb() {
                    ...
                    const pos = ratio * (TRACK_LEN - thumbH);
...
const naScrollbar = `
    <div class="na-scrollbar" aria-hidden="true">
        <svg id="na-svg"
            ...
            <!-- Path del logo nA completo.
                 Transform en cadena (SVG aplica de derecha a izquierda):
                 1. translate(0,1080) scale(0.1,-0.1): convierte coords del path a SVG real (x:116-1872, y:470-658)
                 2. rotate(-90, 993.9, 564): rota el logo 90deg sobre su centro
                 3. scale(0.171, 0.456): escala para que quepa en 32x800
                 4. translate(16,400): centra en el canvas
            -->
            <g transform="translate(-153.11,143.20) scale(0.17021,0.45532) rotate(-90,993.5,564) translate(0,1080) scale(0.1,-0.1)"
            ...
            <!-- Thumb: se mueve verticalmente en el eje Y del canvas 32x800 -->
            <rect id="na-thumb-rect" x="14" y="0" width="4" height="60" fill="currentColor" opacity="0.8"/>
        </svg>
    </div>`;
